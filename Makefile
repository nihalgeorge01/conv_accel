...
testbench_mod.vvp: testbench_mod.v axi4_mem_periph.v picorv32.v
	$(IVERILOG) -o $@ $(subst C,-DCOMPRESSED_ISA,$(COMPRESSED_ISA)) $^
	chmod -x $@
...
testbench_verilator: testbench_mod.v picorv32.v axi4_mem_periph.v conv_accel.v VRAM.v adder.v multiplier.v testbench.cc 
